defmodule ChaudronWeb.Router do
  ...
  scope "/", ChaudronWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{ChaudronWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", ChaudronWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{ChaudronWeb.UserAuth, :ensure_authenticated}] do
      live "/profile/personal_information/create", CreatePersonalInformationLive
  ...
  scope "/", ChaudronWeb do
    ...
    live_session :current_user,
      on_mount: [{ChaudronWeb.UserAuth, :mount_current_user}] do
